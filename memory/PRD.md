...
- BRANDING (2026-06-14): NEW winged coin logo (BRAND.emblem -> /brand/winged_emblem.png, gold Navy-SEAL-style wings + jump wings, generated + white-bg cut). BrandLogo.jsx now object-contain (shows wings). NEW footer underwater watermark (/brand/footer_underwater.jpg, SEAL divers + shark + bubbles) as faded bg layer in Layout.jsx footer (BRAND.footerUnderwater). Verified render.
