...
SLOT_MACHINES = {
    ...
    "obsidian_empire": _machine(
        "obsidian_empire",
        "Obsidian Empire",
        "Command the black-glass throne",
        "olympus",
        "High",
        {
            "crown": 5,
    ...
    "neon_pharaoh": _machine(
        "neon_pharaoh",
        "Neon Pharaoh",
        "Awaken the night-vision dynasty",
        "adventure",
        "High",
        {
            "explorer": 5,
    ...
    "night_raid": _machine(
        "night_raid",
        "Night Raid",
        "Strike hard under cover of dark",
        "olympus",
        "High",
        {
            "crown": 5,
    ...
    "titanium_tundra": _machine(
        "titanium_tundra",
        "Titanium Tundra",
        "Freeze the reels, forge the wins",
        "olympus",
        "High",
        {
            "crown": 5,
