...
export const FLAGSHIP_ART = {
  ...
  thunder_titans: {
    thumb: "/slots/tile_thunder_titans.jpg",
    bg: "/slots/tile_thunder_titans.jpg",
    accent: "#F6E27A",
    frame: "#8a6a1e",
    panel: "#1a1206",
  },
  wild_bandito: {
    thumb: "/slots/tile_wild_bandito.jpg",
    bg: "/slots/tile_wild_bandito.jpg",
    accent: "#E0A24A",
    frame: "#8a5a1e",
    panel: "#201206",
  },
  ...
  night_ops_kingpin: {
    thumb: "/slots/tile_night_ops_kingpin.jpg",
    bg: "/slots/tile_night_ops_kingpin.jpg",
    accent: "#57E6C6",
    frame: "#1E7D6E",
    panel: "#07201d",
  },
  midnight_vanguard: {
    thumb: "/slots/tile_midnight_vanguard.jpg",
    bg: "/slots/tile_midnight_vanguard.jpg",
    accent: "#B07AFF",
    frame: "#5A3A8a",
    panel: "#160a26",
  },
  diamond_commando: {
    thumb: "/slots/tile_diamond_commando.jpg",
    bg: "/slots/tile_diamond_commando.jpg",
    accent: "#C0D0E0",
    frame: "#7a8a9c",
    panel: "#141a20",
  },
  vortex_vanguard: {
    thumb: "/slots/tile_vortex_vanguard.jpg",
    bg: "/slots/tile_vortex_vanguard.jpg",
    accent: "#7FB4FF",
    frame: "#3a5da0",
    panel: "#0a1226",
  },
  redline_reign: {
    thumb: "/slots/tile_redline_reign.jpg",
    bg: "/slots/tile_redline_reign.jpg",
    accent: "#FF5A4A",
    frame: "#a83228",
    panel: "#2a0a08",
  },
  crimson_circuit: {
    thumb: "/slots/tile_crimson_circuit.jpg",
    bg: "/slots/tile_crimson_circuit.jpg",
    accent: "#FF5A4A",
    frame: "#a83228",
    panel: "#2a0a08",
  },
  bull_rush: {
    thumb: "/slots/bg_west.jpg",
    bg: "/slots/bg_west.jpg",
    accent: "#E0A24A",
    frame: "#8a5a1e",
    panel: "#201206",
  ...
  sovereign_strike: {
    thumb: "/slots/tile_sovereign_strike.jpg",
    bg: "/slots/tile_sovereign_strike.jpg",
    accent: "#F6C64A",
    frame: "#8a6a1e",
    panel: "#1a1206",
  },
  aces_high: {
    thumb: "/slots/tile_aces_high.jpg",
    bg: "/slots/tile_aces_high.jpg",
    accent: "#9FD0FF",
    frame: "#3a5da0",
    panel: "#0a1220",
  },
  gold_convoy: {
    thumb: "/slots/tile_gold_convoy.jpg",
    bg: "/slots/tile_gold_convoy.jpg",
    accent: "#FFC04A",
    frame: "#8a6a1e",
    panel: "#1a1206",
  },
  night_raid: {
    thumb: "/slots/tile_night_raid.jpg",
    bg: "/slots/tile_night_raid.jpg",
    accent: "#6EE84A",
    frame: "#3a7a2e",
    panel: "#0e2008",
  },
  titanium_tundra: {
    thumb: "/slots/tile_titanium_tundra.jpg",
    bg: "/slots/tile_titanium_tundra.jpg",
    accent: "#8CE6FF",
    frame: "#2E6DA0",
    panel: "#0a1826",
  },
  jungle_guerrilla: {
    thumb: "/slots/tile_jungle_guerrilla.jpg",
    bg: "/slots/tile_jungle_guerrilla.jpg",
    accent: "#B07AFF",
    frame: "#3a7a2e",
    panel: "#0e2008",
  },
  urban_sniper: {
    thumb: "/slots/tile_urban_sniper.jpg",
    bg: "/slots/tile_urban_sniper.jpg",
    accent: "#FF5A4A",
    frame: "#a83228",
    panel: "#2a0a08",
  },
  stealth_bomber: {
    thumb: "/slots/tile_stealth_bomber.jpg",
    bg: "/slots/tile_stealth_bomber.jpg",
    accent: "#7FB4FF",
    frame: "#3a5da0",
    panel: "#0a1220",
  },
  panzer_plunder: {
    thumb: "/slots/tile_panzer_plunder.jpg",
    bg: "/slots/tile_panzer_plunder.jpg",
    accent: "#F6E27A",
    frame: "#8a6a1e",
    panel: "#1a1206",
  },
  black_hawk_bounty: {
    thumb: "/slots/tile_black_hawk_bounty.jpg",
    bg: "/slots/tile_black_hawk_bounty.jpg",
    accent: "#FFCD4A",
    frame: "#8a6a1e",
    panel: "#1a1206",
  },
  iron_infantry: {
    thumb: "/slots/tile_iron_infantry.jpg",
    bg: "/slots/tile_iron_infantry.jpg",
    accent: "#FF7A3A",
    frame: "#8a4a1e",
    panel: "#201206",
  },
...
const BASE_MACHINE_ART = {
  ...
  book_of_ops: {
    bg: "/slots/tile_book_of_ops.jpg",
    thumb: "/slots/tile_book_of_ops.jpg",
    panel: "#E0B24A",
  },
  big_bass_bombardment: {
    bg: "/slots/bg_bass.jpg",
  ...
  wild_west_recon: {
    bg: "/slots/tile_wild_west_recon.jpg",
    thumb: "/slots/tile_wild_west_recon.jpg",
    panel: "#C9A06A",
  },
  money_train_convoy: {
    bg: "/slots/tile_money_train_convoy.jpg",
  ...
  pharaohs_arsenal: {
    bg: "/slots/tile_pharaohs_arsenal.jpg",
    thumb: "/slots/tile_pharaohs_arsenal.jpg",
    panel: "#E0B24A",
  },
  kraken_depths: {
    bg: "/slots/bg_kraken.jpg",
  ...
  frigate: {
    bg: "/slots/tile_frigate.jpg",
    thumb: "/slots/tile_frigate.jpg",
    panel: "#8FD9FF",
  },
  destroyer: {
    bg: "/slots/tile_destroyer.jpg",
    thumb: "/slots/tile_destroyer.jpg",
    panel: "#8CE6FF",
  },
  bull_rush: {
    bg: "/slots/bg_west.jpg",
  ...
  buffalo_blast: {
    bg: "/slots/tile_buffalo_blast.jpg",
    thumb: "/slots/tile_buffalo_blast.jpg",
    panel: "#F6C64A",
  },
  prairie_royale: {
    bg: "/slots/tile_prairie_royale.jpg",
    thumb: "/slots/tile_prairie_royale.jpg",
    panel: "#FFD84E",
  },
  stampede_skyline: {
    bg: "/slots/tile_stampede_skyline.jpg",
    thumb: "/slots/tile_stampede_skyline.jpg",
    panel: "#C8F274",
  },
  golden_bull_run: {
    bg: "/slots/tile_golden_bull_run.jpg",
    thumb: "/slots/tile_golden_bull_run.jpg",
    panel: "#D4AF37",
  },
  aurora_strike: {
    bg: "/slots/bg_aurora.jpg",
  ...
  gonzo_quest: {
    bg: "/slots/tile_gonzo_quest.jpg",
    thumb: "/slots/tile_gonzo_quest.jpg",
    panel: "#57E6C6",
  },
  thunderstruck_ii: {
    bg: "/slots/tile_thunderstruck_ii.jpg",
    thumb: "/slots/tile_thunderstruck_ii.jpg",
    panel: "#9FD0FF",
  },
  buffalo: {
    bg: "/slots/tile_buffalo.jpg",
    thumb: "/slots/tile_buffalo.jpg",
    panel: "#C9A06A",
  },
  black_wolf: {
    bg: "/slots/tile_black_wolf.jpg",
    thumb: "/slots/tile_black_wolf.jpg",
    panel: "#B8C4B8",
  },
  dead_or_alive_ii: {
    bg: "/slots/tile_dead_or_alive_ii.jpg",
    thumb: "/slots/tile_dead_or_alive_ii.jpg",
    panel: "#FF5A5A",
  },
  reactoonz: {
    bg: "/slots/bg_nebula.jpg",
  ...
  gold_party: {
    bg: "/slots/tile_gold_party.jpg",
    thumb: "/slots/tile_gold_party.jpg",
    panel: "#FFD84E",
  },
  cleopatra: {
    bg: "/slots/bg_pharaoh.jpg",
  ...
  legacy_of_dinosaurs: {
    bg: "/slots/tile_legacy_of_dinosaurs.jpg",
    thumb: "/slots/tile_legacy_of_dinosaurs.jpg",
    panel: "#FF5A5A",
  },
  gates_of_olympus: {
    bg: "/slots/bg_olympus.jpg",
  ...
  fortune_coins: {
    bg: "/slots/tile_fortune_coins.jpg",
    thumb: "/slots/tile_fortune_coins.jpg",
    panel: "#FFD84E",
  },
  year_of_ox: {
    bg: "/slots/bg_ox.jpg",
  ...
  buffalo_gold_rush: {
    bg: "/slots/tile_buffalo_gold_rush.jpg",
    thumb: "/slots/tile_buffalo_gold_rush.jpg",
    panel: "#D4AF37",
  },
  dragon_lightning_link: {
    bg: "/slots/bg_dragon.jpg",
  ...
  dragon_cash: {
    bg: "/slots/tile_dragon_cash.jpg",
    thumb: "/slots/tile_dragon_cash.jpg",
    panel: "#FFD84E",
  },
  dollar_storm: {
    bg: "/slots/bg_storm.jpg",
  ...
  choy_sun_doa: {
    bg: "/slots/tile_choy_sun_doa.jpg",
    thumb: "/slots/tile_choy_sun_doa.jpg",
    panel: "#FFD84E",
  },
  queen_of_the_nile: {
    bg: "/slots/tile_queen_of_the_nile.jpg",
    thumb: "/slots/tile_queen_of_the_nile.jpg",
    panel: "#F6C64A",
  },
  game_of_thrones: {
    bg: "/slots/bg_dynasty.jpg",
  ...
  fortune_coin: {
    bg: "/slots/tile_fortune_coin.jpg",
    thumb: "/slots/tile_fortune_coin.jpg",
    panel: "#FFB454",
  },
  dancing_drums: {
    bg: "/slots/tile_dancing_drums.jpg",
    thumb: "/slots/tile_dancing_drums.jpg",
    panel: "#FF5A5A",
  },
  eighty_eight_fortunes: {
    bg: "/slots/tile_eighty_eight_fortunes.jpg",
    thumb: "/slots/tile_eighty_eight_fortunes.jpg",
    panel: "#FFD84E",
  },
  rich_little_piggies: {
    bg: "/slots/tile_rich_little_piggies.jpg",
    thumb: "/slots/tile_rich_little_piggies.jpg",
    panel: "#FF9EC4",
  },
  triple_supreme_olympus: {
    bg: "/slots/tile_triple_supreme_olympus.jpg",
    thumb: "/slots/tile_triple_supreme_olympus.jpg",
    panel: "#F6E27A",
  },
  cash_machine: {
    bg: "/slots/tile_cash_machine.jpg",
    thumb: "/slots/tile_cash_machine.jpg",
    panel: "#4EE44E",
  },
  golden_century: {
    bg: "/slots/tile_golden_century.jpg",
    thumb: "/slots/tile_golden_century.jpg",
    panel: "#FFD84E",
  },
  seven_seven_crazy: {
    bg: "/slots/tile_seven_seven_crazy.jpg",
    thumb: "/slots/tile_seven_seven_crazy.jpg",
    panel: "#FF5A5A",
  },
  golden_rooster: {
    bg: "/slots/tile_golden_rooster.jpg",
    thumb: "/slots/tile_golden_rooster.jpg",
    panel: "#FFC04A",
  },
  happy_prosperous: {
    bg: "/slots/tile_happy_prosperous.jpg",
    thumb: "/slots/tile_happy_prosperous.jpg",
    panel: "#FFD84E",
  },
  panda_magic_royale: {
    bg: "/slots/tile_panda_magic_royale.jpg",
    thumb: "/slots/tile_panda_magic_royale.jpg",
    panel: "#5EE07A",
  },
  five_kings: {
    bg: "/slots/tile_five_kings.jpg",
    thumb: "/slots/tile_five_kings.jpg",
    panel: "#F6E27A",
  },
  peace_and_long_life: {
    bg: "/slots/tile_peace_and_long_life.jpg",
    thumb: "/slots/tile_peace_and_long_life.jpg",
    panel: "#7FE3FF",
  },
  magic_totem: {
    bg: "/slots/tile_magic_totem.jpg",
    thumb: "/slots/tile_magic_totem.jpg",
    panel: "#C07BFF",
  },
  eyes_of_fortune: {
    bg: "/slots/tile_eyes_of_fortune.jpg",
    thumb: "/slots/tile_eyes_of_fortune.jpg",
    panel: "#7FFFD4",
  },
  fire_of_villa_street: {
    bg: "/slots/tile_fire_of_villa_street.jpg",
    thumb: "/slots/tile_fire_of_villa_street.jpg",
    panel: "#FF7A2E",
  },
  iceland: {
    bg: "/slots/tile_iceland.jpg",
    thumb: "/slots/tile_iceland.jpg",
    panel: "#9FD0FF",
  },
  triple_gold_twister: {
    bg: "/slots/bg_gold.jpg",
  ...
  dragon_deluxe: {
    bg: "/slots/tile_dragon_deluxe.jpg",
    thumb: "/slots/tile_dragon_deluxe.jpg",
    panel: "#FF5A5A",
  },
  polar: {
    bg: "/slots/tile_polar.jpg",
    thumb: "/slots/tile_polar.jpg",
    panel: "#9FD0FF",
  },
  aladdin: {
    bg: "/slots/bg_oasis.jpg",
  ...
  cleopatra_gold: {
    bg: "/slots/tile_cleopatra_gold.jpg",
    thumb: "/slots/tile_cleopatra_gold.jpg",
    panel: "#F6C64A",
  },
  golden_lotus: {
    bg: "/slots/tile_golden_lotus.jpg",
    thumb: "/slots/tile_golden_lotus.jpg",
    panel: "#FF9EC4",
  },
  fortune_lions: {
    bg: "/slots/tile_fortune_lions.jpg",
    thumb: "/slots/tile_fortune_lions.jpg",
    panel: "#FFD84E",
  },
  eggs_and_gold: {
    bg: "/slots/tile_eggs_and_gold.jpg",
    thumb: "/slots/tile_eggs_and_gold.jpg",
    panel: "#F6E27A",
  },
  robin_hood: {
    bg: "/slots/tile_robin_hood.jpg",
    thumb: "/slots/tile_robin_hood.jpg",
    panel: "#4EE44E",
  },
  maya_sun: {
    bg: "/slots/tile_maya_sun.jpg",
    thumb: "/slots/tile_maya_sun.jpg",
    panel: "#FFD84E",
  },
  book_of_sun: {
    bg: "/slots/tile_book_of_sun.jpg",
    thumb: "/slots/tile_book_of_sun.jpg",
    panel: "#F6E27A",
  },
  sun_magic: {
    bg: "/slots/tile_sun_magic.jpg",
    thumb: "/slots/tile_sun_magic.jpg",
    panel: "#FFB454",
  },
  apple_2: {
    bg: "/slots/tile_apple_2.jpg",
    thumb: "/slots/tile_apple_2.jpg",
    panel: "#FF5A5A",
  },
  book_of_wizard: {
    bg: "/slots/tile_book_of_wizard.jpg",
    thumb: "/slots/tile_book_of_wizard.jpg",
    panel: "#C07BFF",
  },
  power_sun: {
    bg: "/slots/tile_power_sun.jpg",
    thumb: "/slots/tile_power_sun.jpg",
    panel: "#FF7A2E",
  },
  sun_of_egypt: {
    bg: "/slots/tile_sun_of_egypt.jpg",
    thumb: "/slots/tile_sun_of_egypt.jpg",
    panel: "#F6C64A",
  },
  sun_of_egypt_2: {
    bg: "/slots/tile_sun_of_egypt_2.jpg",
    thumb: "/slots/tile_sun_of_egypt_2.jpg",
    panel: "#F6C64A",
  },
  sun_of_egypt_3: {
    bg: "/slots/tile_sun_of_egypt_3.jpg",
    thumb: "/slots/tile_sun_of_egypt_3.jpg",
    panel: "#F6C64A",
  },
  sun_of_egypt_4: {
    bg: "/slots/tile_sun_of_egypt_4.jpg",
    thumb: "/slots/tile_sun_of_egypt_4.jpg",
    panel: "#F6C64A",
  },
  three_pigs: {
    bg: "/slots/tile_three_pigs.jpg",
    thumb: "/slots/tile_three_pigs.jpg",
    panel: "#FF9EC4",
  },
  sweet_ammo: {
    bg: "/slots/tile_sweet_ammo.jpg",
    thumb: "/slots/tile_sweet_ammo.jpg",
    panel: "#FF9EC4",
  },
  ironclad_jackpots: {
    bg: "/slots/tile_ironclad_jackpots.jpg",
    thumb: "/slots/tile_ironclad_jackpots.jpg",
    panel: "#C0D0E0",
  },
  blackout_royal: {
    bg: "/slots/tile_blackout_royal.jpg",
    thumb: "/slots/tile_blackout_royal.jpg",
    panel: "#57E6C6",
  },
  stormfront_seven: {
    bg: "/slots/tile_stormfront_seven.jpg",
    thumb: "/slots/tile_stormfront_seven.jpg",
    panel: "#4EA6FF",
  },
  thunder_titans: {
    bg: "/slots/tile_thunder_titans.jpg",
  ...
  brigade_of_gold: {
    bg: "/slots/tile_brigade_of_gold.jpg",
    thumb: "/slots/tile_brigade_of_gold.jpg",
    panel: "#FFCD4A",
  },
  night_ops_kingpin: {
    bg: "/slots/tile_night_ops_kingpin.jpg",
...
const _NEW_ART_FALLBACKS = [
  "/slots/bg_west.jpg",
  "/slots/bg_dynasty.jpg",
  "/slots/bg_neon.jpg",
  "/slots/bg_kraken.jpg",
  "/slots/bg_midnight.jpg",
  "/slots/bg_dragon.jpg",
  "/slots/tile_thunder_titans.jpg",
  "/slots/tile_redline_reign.jpg",
  "/slots/tile_crimson_circuit.jpg",
  "/slots/tile_diamond_commando.jpg",
];
Object.entries(NEW_SLOT_TEMPLATE_ART).forEach(([id, tpl], i) => {
  ...
  BASE_MACHINE_ART[id] = {
    bg,
    thumb,
    panel: src.panel || src.accent || "#4EE44E",
  };
});
...
export const resolveMachineArt = (id, fallback = {}) => {
  ...
  return {
    ...
    thumb:
      fallback.thumb || current.thumb || base.thumb || "/slots/thumb_gold.jpg",
  };
};
