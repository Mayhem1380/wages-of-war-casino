...
export const LEGAL = {
  terms: {
    ...
    sections: [
      ...
      { h: "11. Account Closure & Suspension", body: [
      ...
      { h: "13. Contact", body: [
        { list: ["Email: support@wagesofwarcasino.com", `Operator: ${OP}`, `Licence: ${LIC}`, `Registered Address: ${ADDR}`] },
      ]},
    ],
  },
  ...
  privacy: {
    ...
    sections: [
      ...
      { h: "3. Legal Basis for Processing (GDPR Article 6)", body: [{ list: [
      ...
      { h: "4. How We Use Your Data", body: [{ list: [
      ...
      { h: "9. International Transfers", body: [
        "Where data is transferred outside the EEA, appropriate safeguards (SCCs, adequacy decisions) are in place.",
      ]},
      { h: "10. Changes", body: ["Material changes notified via email or Platform notification."]},
      { h: "11. Contact", body: [{ list: [
  ...
  "responsible-gambling": {
    ...
    sections: [
      ...
      { h: "Self-Assessment", body: ["Ask yourself:", { list: [
      ...
      { h: "Player Protection Tools", body: [{ list: [
      ...
      { h: "Support Organisations", body: [{ list: [
        "Gamblers Anonymous: www.gamblersanonymous.org",
        "GamCare: www.gamcare.org.uk | 0808 8020 133",
        "Gambling Therapy: www.gamblingtherapy.org",
        "BeGambleAware: www.begambleaware.org",
      ]}]},
      { h: "Underage Gambling Prevention", body: [
  ...
  "age-verification": {
    ...
    meta: [["Operator", OP]],
    sections: [
      { h: "Verification Process", body: [{ list: [
  ...
  "aml-policy": {
    title: "AML Policy",
    meta: [["Operator", OP], ["Licence", LIC], ["MLRO", "Kevin J. Smith"]],
    sections: [
      { h: "1. Purpose", body: [
      ...
      { h: "2. Customer Due Diligence (CDD)", body: [{ list: [
      ...
      { h: "3. Transaction Monitoring", body: [
      ...
      { h: "6. Record Keeping", body: ["5 years minimum from last transaction or account closure."]},
  ...
  "bonus-terms": {
    ...
    sections: [
      ...
      { h: "2. Eligibility", body: ["One bonus per player/household/IP/device. Verified account required."]},
      { h: "3. Wagering Requirements", body: [
