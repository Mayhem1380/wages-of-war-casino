...
export function VideoPlaceholder({
  label = "PROMOTIONAL VIDEO — Coming Soon",
  testId,
}) {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <p className="font-mono text-[11px] tracking-widest text-muted-foreground mt-3 animate-flicker">
          // VIDEO CONTENT PENDING UPLOAD
        </p>
      </div>
      <span className="absolute bottom-3 right-3 border border-alert/50 text-alert font-mono text-[10px] px-2 py-0.5">
        REC ●
      </span>
    </div>
  );
