  ...
  const items = [
    {
      ...
      body: "Decide how long you'll play before you start. Wages of War Casino is entertainment — not a way to make money.",
    },
    {
      Icon: HandPalm,
      title: "Take Breaks",
      body: "Step away regularly. Chasing losses is a red flag. Every game here uses virtual play-money credits only.",
    },
    {
      Icon: Heart,
      title: "Play for Fun",
      body: "If gameplay stops being fun, stop playing. Never let a game affect your mood, sleep, or relationships.",
    },
    {
      Icon: Warning,
      title: "18+ Only",
  ...
  return (
    <div data-testid={RG.root} className="max-w-3xl mx-auto px-4 sm:px-8 py-14">
      <div className="text-center mb-10">
        ...
        <p className="font-mono text-xs tracking-[0.4em] text-nvg/70 mt-3">
          // DUTY OF CARE
        </p>
      ...
      <div className="hud p-6">
        <h3 className="font-display text-2xl tracking-wide text-gold flex items-center gap-2">
          <LinkSimple size={22} /> NEED SUPPORT?
        </h3>
        <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
          If you or someone you know needs help with gambling-related concerns,
          confidential support is available at
          <span className="text-nvg"> BeGambleAware.org</span>,
          <span className="text-nvg"> GamCare</span>, and the
          <span className="text-nvg"> National Gambling Helpline</span>. Support
