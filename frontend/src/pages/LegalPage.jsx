    ...
    >
      ...
      <div className="hud hud-gold p-6 mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-mono text-[11px] tracking-[0.4em] text-nvg/70">
              // WAGES OF WAR OPERATIONS LTD.
            </p>
            <h1 className="font-display text-4xl sm:text-5xl tracking-wide gold-gradient leading-none">
              {data.title}
            </h1>
            {data.subtitle && (
              <p className="font-mono text-sm text-alert mt-1">
                {data.subtitle}
              </p>
            )}
          </div>
      ...
      <div className="mt-10 pt-6 border-t border-border flex items-center gap-2 text-muted-foreground">
        ...
        <span className="font-mono text-[11px]">
          18+ • Please gamble responsibly • Licensed by the Malta Gaming
          Authority (MGA/B2C/912/2025)
        </span>
      </div>
    </div>
  );
